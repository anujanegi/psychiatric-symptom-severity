...
def run():
    ...
    challenge_id = 1
    challenge_phase = "pseudo-test"  # Add the challenge phase codename to be tested
    annotation_file_path = "{}/annotations/test_labels_regression.csv".format(
        current_working_directory
    )  # Add the test annotation file path
    user_submission_file_path = "{}/predicted_labels_reg_MOR_randfor.csv".format(
        current_working_directory
